...
use App\Filament\Resources\Admin\UtilityResource\Pages;
use App\Filament\Resources\Admin\UtilityResource\RelationManagers;
...
class UtilityResource extends NestedResource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'block' => Pages\BlockUtility::route('/{record}/block'),
        ];
    }
}
